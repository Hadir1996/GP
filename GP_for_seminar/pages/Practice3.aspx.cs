...
namespace GP_for_seminar.pages
{
    public partial class Practice3 : System.Web.UI.Page
    {
        ...
        static string right_word = "";
        
        static string kid_word = "";
        static string levno;
        static string levtyp;
        static string prano;
        int i = 0;
        int score = 0;
        List<string> word0 = new List<string> { "" };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                fillImages(ImageButton1, (int)ViewState["index"]);

            }

        }
        
        public void fillImages(ImageButton IB1, int listIndex)
        {
            ...
            if (res != null)
            {
                ...
                right_word = res[i].correct.ToString();       
        ...
        protected void speech_Click(object sender, ImageClickEventArgs e)
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "Speech_Recognition", "startRecognition()", true);

        }

        protected void speech_txt_TextChanged(object sender, EventArgs e)
        {

            kid_word = speech_txt.Text.ToString().ToUpper();
            if (kid_word == right_word.ToUpper())
            {
