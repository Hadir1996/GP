...
{
    public partial class Familypractice : System.Web.UI.Page
    {
       ...
       static  string prano;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                fillImages(ImageButton1, ImageButton2, ImageButton3, ImageButton4);
        ...
        public void fillImages(ImageButton IB1, ImageButton IB2, ImageButton IB3, ImageButton IB4)
        {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                ImageButton1.Style["box-shadow"] = "0px 0px 20px rgba(0,0,0,0.5)";
        ...
        protected void replayvoice_Click(object sender, ImageClickEventArgs e)
        {
        ...
        {
            ImageButton1.Style["box-shadow"] = "0px 0px 20px rgba(0,0,0,0)";
        ...
        protected void nextQ_Click(object sender, ImageClickEventArgs e)
        {
            ...
            HttpCookie usernamecookie = Request.Cookies["username"];
                ...
                string redirct = "practice_score.aspx?levelno=1&leveltype=Family";
